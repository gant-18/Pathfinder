...
from bindsnet.network.nodes import DiehlAndCookNodes, Input, LIFNodes, LIFNodesLinearDecay, IFNodes
...
class DiehlAndCook2015ModifiedInh(Network):
    """
    Implements the spiking neural network architecture from `(Diehl & Cook 2015)` with a modified inhibitory layer 
    using LIF neurons with linear decay.
    """
    ...
    def __init__(
        ...
        # Modified inhibitory layer using LIF nodes with linear decay
        inh_layer = LIFNodesLinearDecay(  # Using LinearDecayNodes instead of LIFNodes
            n=self.n_neurons,
            traces=False,
            rest=-60.0,
            reset=-45.0,
...
class DiehlAndCook2015ModifiedExc(Network):
    """
    Modified Diehl & Cook 2015 SNN using IFNodes for excitatory layer.
    """
    ...
    def __init__(
        ...
        # Excitatory layer changed to IFNodes
        exc_layer = IFNodes(
            n=self.n_neurons,
            traces=True,
            rest=-65.0,
